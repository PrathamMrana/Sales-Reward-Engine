...
const PolicySimulation = () => {
    ...
    return (
        <SalesLayout>
            <div className="mb-8">
                <h1 className="section-title">Policy Simulation Mode</h1>
                <p className="text-text-muted">Simulate changes to incentive logic and preview financial impact before applying.</p>
            </div>
