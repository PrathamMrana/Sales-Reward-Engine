    ...
    return (
      <div className="card-modern p-12 text-center relative">
        ...
        <div className="relative z-10">
          ...
          <h3 className="text-sm font-semibold text-gray-700 mb-2">No Monthly Data</h3>
          <p className="text-xs text-gray-500">Create and approve deals to see monthly performance</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="card-modern p-8 relative">
      ...
      <div className="mb-6 relative z-10">
        ...
        <p className="text-sm text-gray-600 mt-2">Deals and incentive by month (approved deals only)</p>
      </div>
