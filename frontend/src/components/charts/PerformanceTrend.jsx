    ...
    return (
      <div className="card-modern p-12 text-center relative">
        ...
        <div className="relative z-10">
          ...
          <h3 className="text-sm font-semibold text-gray-700 mb-2">No Trend Data Yet</h3>
          <p className="text-xs text-gray-500 mb-4">Start creating and approving deals to see performance trends</p>
  ...
  return (
    <div className="card-modern p-8 relative">
      ...
      <div className="mb-8 relative z-10">
        ...
        <p className="text-sm text-gray-600 mt-4">Approved deals only • Incentive is the primary metric</p>
        {useBarChart && (
